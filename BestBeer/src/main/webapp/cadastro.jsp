				          	...
				          	<div class="form-group">
            					<div class="form-row">
            						<div class="col-md-6">
				                		...
				                		<input class="form-control" name="nome" id="inputName" type="text"  placeholder="Nome do produto">
				              		</div>
            						<div class="col-md-6">
            					...
            					<div class="form-row">
					              	...
					              	<div class="col-md-6">
					              		...
					              		<div class="input-group mb-3">
							                ...
							                <input class="form-control" name="preco" id="inputPreco" aria-label="Amount" type="text" placeholder="0.00">
					              		</div>
					              	</div>
           						</div>
          					</div>
