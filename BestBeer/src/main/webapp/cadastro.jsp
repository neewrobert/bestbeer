...
<head>
  ...
  <title>The BEST BEER - CADASTRO</title>
  <!-- Bootstrap core CSS-->
				          	...
				          	<div class="form-group">
            					<div class="form-row">
            						<div class="col-md-6">
				                		...
				                		<input class="form-control" name="nome" id="inputName" type="text"  placeholder="Nome do produto" ${empty nome ? '' : nome }>
				              		</div>
            						<div class="col-md-6">
		            					<label for="inputNacionalidade">Nacionalidade</label>
		            					<input class="form-control" name="nacionalidade" id="inputNacionalidade" type="text"  placeholder="Nacionalidade" value="${empty nacionalidade ? '' : nacionalidade }">
          							</div>
          						</div>
          					</div>
          					<div class="form-group">
            					<div class="form-row">
              						<div class="col-md-6">
						                ...
						                <input class="form-control" name="categoria" id="inputCategoria" type="text" placeholder="Categoria" value="${empty categoria ? '' : categoria }">
              						</div>
					              	<div class="col-md-6">
					              		...
					              		<div class="input-group mb-3">
							                ...
							                <input class="form-control" name="preco" id="inputPreco" aria-label="Amount" type="text" value="${empty preco ? '' : preco }" placeholder="0.00">
					              		</div>
					              	</div>
           						</div>
