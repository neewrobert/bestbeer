...
<body class="bg-dark">
      ...
      <div class="card-body">
        ...
        <form action="register" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input class="form-control" name="email" id="exampleInputEmail1" type="email" aria-describedby="emailHelp" placeholder="Enter email" value="${empty email ? '' : email }">
          </div>
          <div class="form-group">
            <div class="form-row">
              <div class="col-md-6">
                <label for="exampleInputPassword1">Password</label>
                <input class="form-control" name="password" id="exampleInputPassword1" type="password" placeholder="Password" value="${empty pass ? '' : pass }">
              </div>
              <div class="col-md-6">
  ...
  <script src="resource/bootstrap/js/validator.js"></script>
